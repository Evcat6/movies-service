...
class SVGHurtComponent implements IComponent<SVGSVGElement> {
  constructor(private color: CardColor) {}
  ...
  public build() {
    ...
    svgContainer.setAttribute('fill', this.color);
